...
$query = "INSERT INTO utilisateurs (prenom, age, localisation, photo, password, genre, profilRechercher) 
          VALUES (:prenom, :age, :localisation, :photo, :password, :genre, :profilRechercher)";
